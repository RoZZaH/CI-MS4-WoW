...
- Lighter Wine <span style="background:#6E032A">&block;</span> (hex &num;6e032a)

along with <span style="background:#000000">&block;</span> Jet-Black (hex &num;000000) for some text-elements.
